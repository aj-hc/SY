...
namespace RuRo.BLL
{
	...
	{
		private readonly RuRo.DAL.BasedInfo dal=new RuRo.DAL.BasedInfo();
		public BasedInfo()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<RuRo.Model.BasedInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<RuRo.Model.BasedInfo> DataTableToList(DataTable dt)
		{
			List<RuRo.Model.BasedInfo> modelList = new List<RuRo.Model.BasedInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				RuRo.Model.BasedInfo model;
