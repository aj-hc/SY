...
namespace RuRo.BLL
{
	...
	{
		private readonly RuRo.DAL.Log_Import dal=new RuRo.DAL.Log_Import();
		public Log_Import()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public RuRo.Model.Log_Import GetModelByCache(int Id)
		{
			
			string CacheKey = "Log_ImportModel-" + Id;
			...
			return (RuRo.Model.Log_Import)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<RuRo.Model.Log_Import> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<RuRo.Model.Log_Import> DataTableToList(DataTable dt)
		{
			List<RuRo.Model.Log_Import> modelList = new List<RuRo.Model.Log_Import>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				RuRo.Model.Log_Import model;
