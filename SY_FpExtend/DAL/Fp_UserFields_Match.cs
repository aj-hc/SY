...
namespace RuRo.DAL
{
	...
	public partial class Fp_UserFields_Match
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL_SY.GetMaxIDSY("id", "Fp_UserFields_Match"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Fp_UserFields_Match");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Fp_UserFields_Match set ");
			strSql.Append("Fpudf_Id=@Fpudf_Id,");
			strSql.Append("MatchFields=@MatchFields,");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Fp_UserFields_Match ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,Fpudf_Id,MatchFields,IsSearch ");
			strSql.Append(" FROM Fp_UserFields_Match ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,Fpudf_Id,MatchFields,IsSearch ");
			strSql.Append(" FROM Fp_UserFields_Match ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Fp_UserFields_Match T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Fp_UserFields_Match";
