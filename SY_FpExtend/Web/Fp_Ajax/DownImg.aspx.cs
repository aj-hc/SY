...
namespace RuRo.Web.Fp_Ajax
{
    public partial class DownImg : System.Web.UI.Page
    {
        ...
        {
            string strUid = Request.Form["suid"].ToString();
            string strName = Request.Form["spname"].ToString();
            string strdate = Request.Form["timedate"].ToString();
            string strFile = Request.Form["imgpath"].ToString();
